...
def get_ontologywords_as_ontologies(ontologywords, use_fallback_languages: bool):
    ...
    for ontologyword in ontologywords:
        ...
        if (
            ...
            # Keep comma-separated search words grouped by language because localized
            # lists differ in order and length and cannot be aligned safely. Example:
            # https://www.hel.fi/palvelukarttaws/rest/v4/ontologyword/317/
            ontologies.append(
                OntologyObject(
