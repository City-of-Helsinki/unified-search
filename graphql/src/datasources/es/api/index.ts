export { default as getAdministrativeDivisions } from './getAdministrativeDivisions.js';
export { default as getOntologyTree } from './getOntologyTree.js';
export { default as getOntologyWords } from './getOntologyWords.js';
