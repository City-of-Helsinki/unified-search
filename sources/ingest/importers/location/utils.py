...
def get_ontologywords_as_ontologies(ontologywords, use_fallback_languages: bool):
    ...
    for ontologyword in ontologywords:
        ...
        if (
            ...
            # FIXME: Broken handling of extra_searchwords_*, they are comma separated values,
            #        not a single word. Localizations don't necessarily match in order or length.
            #        Example: https://www.hel.fi/palvelukarttaws/rest/v4/ontologyword/317/
            #        - "extra_searchwords_fi": "koira-aitaukset, koira-aitaus, koirapuistot, koirat"
            #        - "extra_searchwords_sv": "hundar, hundinhägnader, hundparker, hundrastgårdar"
...
def get_ontologytree_as_ontologies(ontologytree, use_fallback_languages: bool):
    ...
    for ontologybranch in ontologytree:
        ...
        if (
            ...
            # FIXME: Broken handling of extra_searchwords_*, they are comma separated values,
            #        not a single word. Localizations don't necessarily match in order or length.
            #        Example: https://www.hel.fi/palvelukarttaws/rest/v4/ontologytree/63/
            #        - "extra_searchwords_fi": "koira-aitaukset, koira-aitaus, koirapuistot, koirat"
            #        - "extra_searchwords_sv": "hundar, hundinhägnader, hundparker, hundrastgårdar"
            #        - "extra_searchwords_en": "dog parks, dogs"
            ontologies.append(
