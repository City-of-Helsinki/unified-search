...
flowchart BT
  ...
  DataCollector -- reads --> Sources -- mapped to --> Elasticsearch
...
| OpenSearch Dashboard Dev Tools            | http://localhost:5601/app/dev_tools#/console |
| OpenSearch                                | http://localhost:9200                        |
| [Data collector](./sources/README.md)     | http://localhost:5001/                       |

### Running without Docker

**Caveat emptor**:

    Running without Docker is only partially supported, so this setup may prove difficult. You have been warned.
